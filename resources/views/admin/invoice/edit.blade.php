                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="invoice[status]"
                                                            ...
                                                            @foreach($houses as $house)
                                                                <option
                                                                    value="{{$house['id']}}"
                                                                    @if(isset($invoice->apartaments->houses) && $house['id'] == $invoice->apartaments->houses['id']) selected @endif>{{$house['house_name']}}</option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="col-sm-12 col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="invoice[status]"
                                                            ...
                                                            <option value="">Выберите...</option>
                                                            <option value="10"
                                                                    @if($invoice['status'] == 10) selected @endif>
                                                                Оплачена
                                                            </option>
                                                            <option value="5"
                                                                    @if($invoice['status'] == 5) selected @endif>
                                                                Частично оплачена
                                                            </option>
                                                            <option value="0"
                                                                    @if($invoice['status'] == 0) selected @endif>
                                                                Неоплачена
                                                            </option>
                                                        </select>
                                                        ...
                                                        <select class="form-control" name="invoice[tariff_id]"
                                                            ...
                                                            @foreach($tariffs as $tariff)
                                                                <option value="{{$tariff['id']}}"
                                                                        @if($invoice['tariff_id'] == $tariff['id']) selected @endif>{{$tariff['name']}}</option>
                                                            @endforeach
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="input-group date col-md-6 datepicker"
                                                            ...
                                                            <input type="text" class="form-control"
                                                                   ...
                                                                   value="{{date('d-m-Y', strtotime($invoice['period_start']))}}">
                                                        ...
                                                        <div class="input-group date col-md-6 datepicker"
                                                            ...
                                                            <input type="text" class="form-control"
                                                                   ...
                                                                   value="{{date('d-m-Y', strtotime($invoice['period_end']))}}">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" id="account_number" class="form-control"
                                                           name="account_number"
                                                           value="{{$invoice->apartaments->accounts['number']}}">
                                                    <input type="hidden" id="account_numberId" class="form-control"
                                                           name="account_numberId"
                                                           value="{{$invoice->apartaments->accounts['id']}}">
                                                </div>
                                            </div>
                                                        ...
                                                        <table class="table table-bordered table-hover">
                                                            ...
                                                            <tr id="invoiceService-1" class="invoiceService">
                                                                <td><input type="hidden" id="invoiceServiceId-1"
                                                                           name="invoiceService[{{$key}}][id]" value="{{$invoiceService['id']}}">
                                                                    <input
                                                                        type="hidden" id="invoiceserviceInvoiceId-1"
                                                                        name="invoiceService[{{$key}}][invoice_id]"
                                                                        value="0">
                                                                    <select id="invoiceServiceId"
                                                                        ...
                                                                        @foreach($services as $service)
                                                                            <option value="{{$service['id']}}" @if($service['id'] == $invoiceService['service_id']) selected @endif>{{$service['name']}}</option>
                                                                        @endforeach
                                                                    </select></td>
                                                                <td>
                                                                    <input type="text" id="invoiceServiceAmount-1"
                                                                           class="form-control service-amount"
                                                                           name="invoiceService[{{$key}}][amount]" value="{{$invoiceService['amount']}}">
                                                                </td>
                                                                <td><select id="unit-1" class="form-control unit"
                                                                            name="unit[1]">
                                                                        <option value="">Выберите...</option>
                                                                        @foreach($units as $unit)
                                                                            <option value="{{$unit['id']}}" @if($unit['id'] == $invoiceService->services->units['id']) selected @endif>{{$unit['name']}}</option>
                                                                        @endforeach
                                                                    </select></td>
                                                                <td>
                                                                    <input type="text" id="invoiceServicePriceUnit-1"
                                                                           class="form-control service-price-unit"
                                                                           name="invoiceService[{{$key}}][price_unit]" value="{{$invoiceService['price_unit']}}">
                                                                </td>
                                                                <td>
                                                                    <input type="text" id="invoiceServicePrice-1"
                                                                           class="form-control service-price"
                                                                           name="invoiceService[{{$key}}][price]" value="{{$invoiceService['price']}}">
                                                                </td>
                                                                <td>
                                                                    <a href="{{route('admin.invoiceServiceRemove', $invoiceService['id'])}}" class="btn btn-default border border-left-0"> <i class="fa fa-trash"></i></a>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                <td colspan="4">
                                                                    ...
                                                                    <button type="button" id="add-tariff-service" class="btn btn-default">
