        ...
        <div class="row">
            ...
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <!-- form start -->
                    <form action="{{route('adminApartamentsUpdate', $apartments['id'])}}" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="numberApartaments"
                                                   id="inputNumberApartaments" value="{{$apartments['number']}}">
                                        </div>
                                        <div class="form-group">
                                            <label for="inputSSquare">Площадь (кв.м.)</label>
                                            <input type="text" class="form-control" name="squareApartaments"
                                                   id="inputsquareApartaments" value="{{$apartments['square']}}">
                                        </div>
                                            ...
                                            <label for="inputHouse">Дом</label>
                                                <select class="form-control" name="house"  id="house-list">
                                                    ...
                                                    @foreach($houses as $house)
                                                        <option value="{{$house['id']}}" @if($apartments['houses_id'] == $house['id']) selected @endif>{{$house['house_name']}}</option>
                                                    @endforeach
                                                </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="section"  id="section-list">
                                                <option value="">Выберите...</option>
                                                <option value="{{$apartments['sections']['id']}}" selected>{{$apartments['sections']['name']}}</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="flours"  id="flours-list">
                                                <option value="">Выберите...</option>
                                                @if(isset($apartments['flours']))
                                                <option value="{{$apartments['flours']['id']}}" selected>{{$apartments['flours']['name']}}</option>
                                                @endif
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="owner"   id="owner-list">
                                                ...
                                                @foreach($users as $user)
                                                    <option value="{{$user['id']}}" @if($apartments['user_id'] == $user['id']) selected @endif>{{$user['lastname']}} {{$user['firstname']}} {{$user['middlename']}} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="tariff"  id="tariff-list">
                                                ...
                                                @foreach($tariffs as $tariff)
                                                    <option value="{{$tariff['id']}}" @if($apartments['tariff_id'] == $tariff['id']) selected @endif>{{$tariff['name']}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="numberPersonalAccount"
                                                       id="inputNumberPersonalAccount" value="@if(isset($apartments['accounts']))  {{$apartments['accounts']['number']}}  @endif">

                                                <input type="hidden" class="form-control" name="numberPersonalAccountId"
                                                       id="inputNumberPersonalAccountId" value="@if(isset($apartments['accounts']))  {{$apartments['accounts']['number']}}  @endif">
