            ...
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="w0" action="{{route('admin.userAdmin-save')}}" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="user-firstname" class="form-control" name="UserAdmin[firstname]">

                                    </div>

                                    <div class="form-group">
                                        <label class="form-label" for="user-lastname">Фамилия</label>
                                        <input type="text" id="user-lastname" class="form-control" name="UserAdmin[lastname]">

                                    </div>

                                    <div class="form-group">
                                        <label class="form-label" for="user-phone">Телефон</label>
                                        <input type="text" id="user-phone" class="form-control" name="UserAdmin[phone]">
