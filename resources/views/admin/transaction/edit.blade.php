...
@section('title')
    @if($accountTransaction->type == 'out') Расходная ведомость @else Приходная ведомость @endif
...
@section('content')
    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="col-xl-12">
                <form action="{{route('admin.account-transaction.update', $accountTransaction->id)}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                    @method('PUT')
                            ...
                            <div class="form-group col-sm-12 col-md-5 col-lg-3">
                                ...
                                <div class="input-group date datepicker" id="datepicker">
                                    ...
                                    <input type="text" class="form-control" name="transaction[uid_date]"
                                           value="{{$accountTransaction->uid_date}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xl-12 col-md-6 offset-6">
                                                ...
                                                <label><input type="checkbox" id="transaction-is_checked"
                                                              name="invoice[is_checked]" value="1" @if($accountTransaction->status == 10) checked @endif>Проведена</label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 col-md-6">
                                                    @if($accountTransaction->type != 'out')
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="user_id"
                                                            ...
                                                            @foreach($users as $user)
                                                                ...
                                                                <option value="{{$user['id']}}" @if($user['id'] == $accountTransaction->account->apartaments['user_id'] ) selected @endif> {{$user['lastname']}}  {{$user['firstname']}} {{$user['middlename']}}</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="transaction[account_id]"
                                                            ...
                                                            <option value="{{$account['id']}}" @if($account['id'] == $accountTransaction->account_id) selected @endif>{{$account['number']}}</option>
                                                            @endforeach
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control"
                                                            ...
                                                            @foreach($purpose as $purposeItem)
                                                                <option value=" {{$purposeItem->id}}" @if($purposeItem->id == $accountTransaction->transaction_purpose_id) selected @endif>{{$purposeItem->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" id="transaction-amount"
                                                               ...
                                                               aria-invalid="true" value="{{$accountTransaction->amount}}">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="transaction[admin]"
                                                            ...
                                                            @foreach($usersAdmin as $userAdmin)
                                                                 <option value="{{$userAdmin->id}}" @if($accountTransaction->user_admin_id == $userAdmin->id) selected @endif >@if(empty($userAdmin->lastname) && empty($userAdmin->firstname))
                                                                        (не задано) @else
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <textarea id="transaction-description" class="form-control"
                                          name="transaction[description]" rows="5" aria-invalid="false">{{$accountTransaction->description}}</textarea>
                            </div>
                        </div>
                    </div>
                </form>
