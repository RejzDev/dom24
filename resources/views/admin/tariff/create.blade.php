                                                ...
                                                <div class="col-sm-12 col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="tariff[name]"
                                                               id="inputService"
                                                               value="@if(isset($tariff['name'])) {{$tariff['name']}} @endif">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control " name="tariff[description]"
                                                                  id="inputDescription"
                                                                  rows="6" aria-invalid="false">@if(isset($tariff['description']))
                                                                {{$tariff['description']}}
                                                            @endif </textarea>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-sm-12 col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group mb-3">
                                                                 ...
                                                                 <button type="button"
                                                                         class="btn btn-default border border-left-0 removeVar "
                                                                         id="' + varCount + '">
